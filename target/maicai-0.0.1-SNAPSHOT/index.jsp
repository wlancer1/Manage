			...
			<div class="span9">
				...
				<div class="row-fluid">
					<div class="page-header">
						<h1>
							统计 <small>Approve or Reject</small>
						</h1>
					</div>
					<div class="row-fluid">
						<div class="span3">
							<h3>用户数量</h3>
							<p>
								<a href="<%=request.getContextPath()%>/SCYH/query_YHAction" class="badge badge-inverse"><%=size3%></a>
							</p>
						</div>
						<div class="span3">
							<h3>蔬菜数量</h3>
							<p>
								<a href="<%=request.getContextPath()%>/SCGL/query_SCAction" class="badge badge-inverse"><%=size%></a>
							</p>
						</div>
						<div class="span3">
							<h3>订单</h3>
							<p>
								<a href="<%=request.getContextPath()%>/SCDD/query_DDAction" class="badge badge-inverse"><%=size2%></a>
							</p>
						</div>
					</div>
				</div>
