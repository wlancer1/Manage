			...
			<div class="span3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="<%=request.getContextPath()%>/SCGL/query_SCAction">蔬菜</a></li>
			...
			<div class="span9">
				<div class="row-fluid">
					...
					<form class="form-horizontal"
						action="<%=request.getContextPath()%>/SCGL/edit_SCAction?ts=<s:property value="#request.ts"/>"
